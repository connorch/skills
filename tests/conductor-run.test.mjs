...
test("plans local skill installs with codex skills Claude-only and other skills shared", () => {
  ...
  assert.deepEqual(commands, [
    ...
    `skills add ${repoRoot} -g -a claude-code -a codex -s babysit-pr file-pr file-upload html-communication qa-ux-fix-loop qa-ux-plan qa-ux-verify sb-ingest sb-ingest-superwhisper-meeting step-back -y`,
  ]);
});
