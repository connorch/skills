...
description: When the user asks for an HTML writeup of work (NOT as part of the codebase), use this skill to create and always upload it to Postplan. Also useful for reading postplan.dev URLs.
metadata:
